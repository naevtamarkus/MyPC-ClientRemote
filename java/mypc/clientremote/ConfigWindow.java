    ...
    public static void display() {
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                // TODO make it so that we can only show this window once, to avoid overwriting
                // this. Singleton maybe?
            }
        });
    }
        ...
        butScan.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent e) {
                if (scanner != null && scanner.isScanning()) {
                    ...
                    // @Override
                    // public void run() {
                    // // Somehow running the scanner seems to interact with the drawing of the
                    // widgets
                    // // Running it from a separate thread later seems to do the trick (not sure
                    // why, though)
                    // scanner.cancel();
                    // }
                    // });
